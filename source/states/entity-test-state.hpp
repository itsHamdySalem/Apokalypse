...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        //TODO (DONE): (Req 8) Change the following line to compute the correct view projection matrix
        ...
        for(auto& entity : world.getEntities()){
            ...
            //TODO (DONE): (Req 8) Complete the loop body to draw the current entity
            ...
            meshRenderer->material->shader->set("transform", VP * localToWorldMatrix);
