...
namespace our {
    ...
    glm::mat4 CameraComponent::getViewMatrix() const {
        ...
        //TODO (DONE): (Req 8) Complete this function
        //HINT:
        // In the camera space:
        ...
        glm::vec3 eyeVec3 = glm::vec3(eye);
        glm::vec3 centerVec3 = glm::vec3(center);
        glm::vec3 upVec3 = glm::vec3(up);
        return glm::lookAt(eyeVec3, centerVec3, upVec3);
    }

    // Creates and returns the camera projection matrix
    // "viewportSize" is used to compute the aspect ratio
    glm::mat4 CameraComponent::getProjectionMatrix(glm::ivec2 viewportSize) const {
        //TODO (DONE): (Req 8) Wrtie this function
