...
our::Texture2D* our::texture_utils::empty(GLenum format, glm::ivec2 size){
    ...
    //TODO (DONE): (Req 11) Finish this function to create an empty texture with the given size and format
    texture->bind();
...
our::Texture2D* our::texture_utils::loadImage(const std::string& filename, bool generate_mipmap) {
    ...
    //TODO (DONE): (Req 5) Finish this function to fill the texture with the data found in "pixels"
